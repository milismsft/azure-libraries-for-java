...
/**
 * The maximum allowed storage capacity for a "PremiumRS" edition of an Azure SQL Elastic Pool.
 */
@Fluent
@Beta(Beta.SinceVersion.V2_0_0)
public enum SqlDatabasePremiumRSStorage {
    ...
    SqlDatabasePremiumRSStorage(long capacityInMB) {
